...
export default function Preloader({ isLoading, onFinish }) {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] flex items-center justify-center bg-gradient-to-br from-primary via-primary-dark to-slate-950 transition-opacity duration-600 ${
